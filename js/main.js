...
$(function() {
    ...
    globals = initGlobals();
    globals.threeView = initThreeView($("#threeContainer"), globals);
    globals.controls = initControls(globals);
    globals.UI3D = init3DUI(globals);
    globals.FileImporter = FileImporter(globals);

    globals.Model3D = Model3D({colorMode: globals.colorMode, frontColor: globals.color1, backColor: globals.color2}, globals.warn);
    ...
    globals.PatternImporter = PatternImporter(globals.warn, globals.notSupportedWarning);
